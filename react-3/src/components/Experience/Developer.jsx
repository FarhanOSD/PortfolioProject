...
Command: npx gltfjsx@6.5.3 public/models/690b9e92d9d72e80a56beb74.glb 
*/
...
import { SkeletonUtils } from 'three-stdlib';
  ...
  function Developer({ animationName = 'idle', ...props }) {
    const { scene } = useGLTF('/models/690b9e92d9d72e80a56beb74.glb');
    const group = useRef();
    const clone = React.useMemo(() => SkeletonUtils.clone(scene), [scene]);
    const { nodes, materials } = useGraph(clone);

    const { animations: idleAnimation } = useFBX(
      '/models/animations/Excited.fbx'
    );
    ...
    // Add this effect here for rotation
    // useEffect(() => {
...
useGLTF.preload('/models/690b9e92d9d72e80a56beb74.glb')
